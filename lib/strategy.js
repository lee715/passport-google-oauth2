...
function Strategy (options, verify) {
  ...
  var url = URL.parse(this._userProfileURL)
  ...
  if (options.agent) {
    this._oauth2._agent = new Sock5Agent(options.agent)
  }
  this._oauth2._request = _request
}
...
function _request (method, url, headers, post_body, access_token, callback) {
